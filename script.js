...
const ENROLLMENT_REQUIRED_REMARK = 'नामांकन करवाया गया है, परंतु आधार कार्ड नहीं मिला है';
const REMARK_PRESETS = [
  ...
  'मृत्यु',
  'पलायन',
  'नया मतदाता पहचान पत्र उपलब्ध नहीं है',
  ENROLLMENT_REQUIRED_REMARK,
  'बच्चा अनाथ है',
  'नामांकन करवाया गया है, परंतु अस्वीकृत हो गया है'
];
...
function getReportSectionData(section) {
  if (section === 'block') {
    ...
    return {
      ...
      headers: ['ब्लॉक', 'कुल सदस्य', 'आधार भरे', 'दर्ज विवरण भरे', 'रिमार्क मात्र', 'खाली', 'पूर्णता %'],
      rows
    };
  }
